...
export default class Home extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div>
            <h1>Hello, world!</h1>
            <ol>
                <li>测试账号 test@test.com test1234</li>
                <li><a href='/mylibrary'>简单记事本</a> using React</li>
                <li><a href='/mall/products'>商品浏览</a> using Razor</li>
                <li><a href='/avmt'>设备浏览</a> using Razor</li>
            </ol>
            {
