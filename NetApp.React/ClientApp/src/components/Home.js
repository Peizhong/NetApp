...
to return here.
      ...
      <li>
        <strong>Development server integration</strong>
. In development mode, the development server
        from
...
. In production mode, development-time features
        are disabled, and your
...
subdirectory is a standard React application based on the
      ...
      <code>create-react-app</code>
      {' '}
template. If you open a command prompt in that directory, you
      can run
      <code>npm</code>
      {' '}
commands such as
